...
// //                 className="w-full py-4 bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] text-white font-semibold rounded-[10px] shadow-md hover:shadow-lg transition-all relative overflow-hidden"
// //               >
// //                 <a href="./main.html" className="text-white no-underline block w-full">
// //                   Login
// //                 </a>
// //               </button>
// //             </form>
...
//         setQuote(data.quote || "Design is not just what it looks like and feels like. Design is how it works.");
//       } catch (err) {
